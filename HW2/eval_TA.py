...
def parse_args():
    ...
    parser.add_argument('--data_path', type=Path, default='./dataset/public.json', help='Original data JSON file')
    parser.add_argument('--prediction_path', type=Path, default='F:/Desktop/predictions.json', help='Model prediction JSON file')
...
def pred_score(data_path, prediction_path, output_path):
