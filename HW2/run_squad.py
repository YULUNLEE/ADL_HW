...
def parse_args():
    ...
    parser.add_argument('--data_path', type=Path, default='F:/project/pycharm/pytorch/ADL_HW/HW2/hw2_dataset/dataset/public.json', help='Original data JSON file')
    parser.add_argument('--prediction_path', type=Path, default='F:/project/pycharm/pytorch/ADL_HW/HW2/BERT-for-Chinese-Question-Answering-master/output/predictions.json', help='Model prediction JSON file')
    parser.add_argument('--output_path', type=Path, default='123.json', help='Evaluation result save file')
