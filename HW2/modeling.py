...
class BertForQuestionAnswering(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids, attention_mask, start_positions=None, end_positions=None):
        ...
        # print('1', logits.shape) #torch.Size([4, 384, 2])
        # print(start_logits.shape) #torch.Size([4, 384])
        # print(end_logits.shape) #torch.Size([4, 384])
        ...
        if start_positions is not None and end_positions is not None:
            ...
            # print('113:', ignored_index)
            # print(start_positions)
            # print(torch.max(start_logits, 1)[1])
            # print(end_positions)
            # print(torch.max(end_logits, 1)[1])
